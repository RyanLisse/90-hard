  ...
  return (
    ...
    >
      <SP.SwitchRoot
        ...
        asChild
        className={cn(
          'peer h-6 w-11 shrink-0 cursor-pointer flex-row items-center rounded-full border-2 border-transparent transition-colors',
        ...
        <Pressable disabled={disabled}>
          <SP.SwitchThumb
            ...
            className={cn(
              ...
              'web:shadow-foreground/5 web:shadow-md',
      ...
      {label && (
        <Text
          className={cn(
            'ml-2 select-none text-primary text-sm',
