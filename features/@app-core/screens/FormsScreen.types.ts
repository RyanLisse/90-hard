import type { useFormState } from '@green-stack/forms/useFormState';
import { inputOptions, schema, z } from '@green-stack/schemas';
...
export type EfficiencyFormState = ReturnType<
  typeof useFormState<(typeof FormScreenProps)['shape']>
>;
