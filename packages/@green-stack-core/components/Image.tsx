...
const Image = ((props: UniversalImageProps) => {
  ...
  if (!Image.clearDiskCache) {
    Image.clearDiskCache = ContextImage.clearDiskCache;
  }
  if (!Image.clearMemoryCache) {
    Image.clearMemoryCache = ContextImage.clearMemoryCache;
  }
  if (!Image.getCachePathAsync) {
    Image.getCachePathAsync = ContextImage.getCachePathAsync;
  }
  if (!Image.prefetch) {
    Image.prefetch = ContextImage.prefetch;
  }
