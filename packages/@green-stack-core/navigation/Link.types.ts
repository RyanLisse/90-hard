...
export type ExtractParams<HREF extends KnownRoutes> =
  HREF extends `${infer START}/[${infer PARAM}]${infer REST}`
...
export type RequireParamsIfDynamic<HREF extends KnownRoutes> =
  ExtractParams<HREF> extends never
...
export type { NextLinkProps, ExpoLinkProps };
