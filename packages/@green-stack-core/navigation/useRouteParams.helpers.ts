...
export const extractParams = (
  ...
  if (params instanceof Promise) {
    return use(params as any as Promise<Record<string, unknown>>);
  }
...
export const universalRouteProps = <T extends Record<string, unknown>>(
  ...
  return {
    ...
    params: extractParams(
      params as Record<string, unknown> | Promise<Record<string, unknown>>
    ),
    searchParams: extractParams(
      searchParams as Record<string, unknown> | Promise<Record<string, unknown>>
    ),
  } as T & {
